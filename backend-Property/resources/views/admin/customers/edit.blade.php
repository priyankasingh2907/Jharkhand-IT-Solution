	...
	<div class="container-fluid">
		...
		<div class="card">
			...
			<div class="card-body">
					<div class="row">
						<div class="col-md-6">
							<div class="mb-3">
								...
								<input type="text" value="{{$customers->fname}}"name="fname" id="fname" class="form-control" placeholder="First-Name">
								<p></p>
							</div>
						</div>
						<div class="col-md-6">
							<div class="mb-3">
								...
								<input type="text" value="{{$customers->lname}}"name="lname" id="lname" class="form-control" placeholder="Last-Name">
								<p></p>
							</div>
						</div>
						...
						<div class="col-md-6">
							...
							<label for="email">Email</label>
								<input disabled readonly type="text" value="{{$customers->email}}"name="email" id="email" class="form-control" placeholder="Email">
							<p></p>
							</div>
						</div>
					</div>
					...
					<div class="row">
					<div class="col-md-6">
					<img id="imagePreview" src="{{asset('uploads/customers/'. $customers->image)}}" alt="Image Preview" class="img-fluid" width="50px" height="50px">
						...
						<div class="col-md-12">
										<div class="mb-3">
											...
											<input type="text"  value="{{$customers->phone}}" name="phone" id="phone" class="form-control" placeholder="Phone">	
											<p></p>
										</div>
									</div>
									<div class="col-md-12">
						...
						<div class="col-md-6">
							<div class="mb-3">
                                ...
                                <option value="1" class="form-control" {{($customers->status ==1)?'selected':""}} >Active</option>
									<option value="0" class="form-control"{{($customers->status ==1)?'selected':""}} >Inactive</option>
								</select>
								</select>
							</div>
						</div>
					...
					<div class="pb-5 pt-3">
						...
						<a href="{{route('customers.edit',$customers->id)}}" class="btn btn-outline-dark ml-3">Cancel</a>
					</div>
				</div>
			</form>
		</div>
...
<script>
	$("#customerForm").submit(function(e) {
		...
		$.ajax({
			url: "{{route('customers.update',$customers->id)}}",
			type: "POST",
